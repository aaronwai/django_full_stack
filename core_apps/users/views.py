    ...
    def post(self, request:Request, *args, **kwargs)->Response:
        ...
        if token_res.status_code == status.HTTP_200_OK:
            ...
            if access_token and refresh_token:
                set_auth_cookie(token_res, access_token=access_token, refresh_token=refresh_token)
                ...
                logger.error("Access Token or Refresh Token not found in response")     
        return token_res
...
class CustomTokenRefreshView(TokenRefreshView): 
    ...
    def post(self, request:Request, *args, **kwargs)->Response:
        ...
        if refresh_res.status_code == status.HTTP_200_OK:
            ...
            if access_token and refresh_token:
                set_auth_cookie(refresh_res, access_token=access_token, refresh_token=refresh_token)
                ...
                refresh_res.data["message"] = "Access Token Refresh Not Found in refresh response data"
...
class CustomProviderAuthView(ProviderAuthView): 
    ...
    def post(self, request:Request, *args, **kwargs)->Response:
        ...
        if provider_res.status_code == status.HTTP_201_CREATED  :
            ...
            if access_token and refresh_token:
                set_auth_cookie(provider_res, access_token=access_token, refresh_token=refresh_token)
