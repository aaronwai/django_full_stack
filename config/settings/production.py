...
ALLOWED_HOSTS = [".bluesea.fit"]
ADMINS= [("Admin", "aaron.lung.wai@gmail.com"),]
...
SECURE_HSTS_INCLUDE_SUBDOMAINS= getenv("DJANGO_SECURE_HSTS_INCLUDE_SUBDOMAINS","True") == "True"
SECURE_HSTS_PRELOAD = getenv("DJANGO_SECURE_HSTS_PRELOAD","True") == "True"
SECURE_CONTENT_TYPE_NOSNIFF= getenv("DJANGO_SECURE_CONTENT_TYPE_NOSNIFF","True") == "True"

CSRF_TRUSTED_ORIGINS = ["https://bluesea.fit", "https://www.bluesea.fit"]
